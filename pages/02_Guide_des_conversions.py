...
st.set_page_config(page_title="Guide des conversions", page_icon="📘", layout="wide")
...
render_hero(
    "Guide",
    "Comprendre avant même de calculer.",
    (
        "Cette page explique simplement ce que fait chaque conversion, quand l'utiliser, "
        "ce qu'il faut renseigner et à quoi sert le résultat."
    ),
)

render_section_title(
    "Mode d'emploi",
    "Parcourez les familles ci-dessous. Chaque conversion est décrite en langage simple pour faciliter la prise en main.",
)
